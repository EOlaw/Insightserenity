...
// Import sub-schemas
const teamMemberSchema = require('./schemas/team-member-schema');
const milestoneSchema = require('./schemas/milestone-schema');
const budgetItemSchema = require('./schemas/budget-item-schema');
const riskSchema = require('./schemas/risk-schema');
const changeRequestSchema = require('./schemas/change-request-schema');
const communicationLogSchema = require('./schemas/communication-log-schema');
