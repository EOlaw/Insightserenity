// src/app/api/hosted-organizations/organizations/[...params]/route.ts
...
// Dynamic route handler for all organization endpoints
async function handleRequest(
  ...
  const endpoint = `/organizations/${pathSegments.join('/')}${queryString ? `?${queryString}` : ''}`;
